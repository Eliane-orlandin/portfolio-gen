...
async function getAboutGitHub() {
    try {
        const resposta = await fetch('https://api.github.com/users/Eliane-orlandin');
      ...
      <article class="about-content">
        <h2>Sobre mim</h2>
        <p>
          Sou desenvolvedora Full Stack com uma trajetória marcada pela resiliência e adaptabilidade.
                    Vinda de uma área completamente diferente, decidi abraçar a transição de carreira e me
                    formei em Análise e Desenvolvimento de Sistemas. Essa mudança me ensinou a ter um olhar
                    diversificado para a resolução de problemas e a valorizar o aprendizado contínuo.
        </p>

        <p>
          Atualmente, meu foco principal é a construção de aplicações robustas utilizando o
                    ecossistema Java para o back-end, além do controle de versionamento com Git e GitHub.
                    Também sou uma grande entusiasta do universo da Inteligência Artificial, explorando o poder
                    dos Agentes de IA e da Engenharia de Prompts para criar soluções cada vez mais inovadoras e
                    eficientes.
        </p>
        ...
        <div class="about-buttons-data">
          <div class="buttons-container">
            ...
            <a href="https://drive.google.com/drive/folders/1uW0p03Og_uaNwqzTWsOsBjpZER4z4lAB?usp=sharing" target="_blank" class="botao-outline">Currículo</a>
          </div>
...
async function getProjectsGithub() {
    try {
        ...
        const resposta = await fetch('https://api.github.com/users/Eliane-orlandin/repos?sort=updated&per_page=6');
